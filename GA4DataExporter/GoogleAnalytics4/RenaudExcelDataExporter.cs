        ...
        public void Export(Dictionary<int, IGoogleRecord> dataFormatedByCountry)
        {
            ...
            foreach (var valueDataForm in dataFormatedByCountry)
            {
                ...
                if (site == 1)
                {
                    ...
                    sheet.Cell(currentRow, 1).Value = " Temps réponse serveur / WebPerf Total (mdds)";
            ...
            sheet.Range("A2:B14").Style.NumberFormat.SetFormat("# ### ### 000.00");                  /* Format séparateur de milliers */
         
            sheet.Range("A15:B16").Style.NumberFormat.SetFormat("0.00");                             /* Format séparateur de milliers */
            ...
            file.SaveAs(@"C:\Users\stagiaireit\Desktop\ExcelReport.xlsx");
        }
