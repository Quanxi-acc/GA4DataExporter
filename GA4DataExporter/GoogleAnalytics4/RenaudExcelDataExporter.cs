...
namespace GoogleAnalytics4
{
    public class RenaudExcelDataExporter : IDataExporter
    {
        ...
        public void Export(Dictionary<int, IGoogleRecord> dataFormatedByCountry)
        {
            ...
            GenerateMainReport(file, dataFormatedByCountry);     /* Rapport classique avec DateRange */
            GenerateDailyReport(file, dataFormatedByCountry);    /* Rapport par jour */
            GenerateMonthlyReport(file, dataFormatedByCountry);  /* Rapport par mois */
            GenerateYearlyReport(file, dataFormatedByCountry);   /* Rapport par année */

            file.SaveAs(@"C:\Users\stagiaireit\Desktop\OOG_GA4_Report.xlsx");
        }

        private void GenerateMainReport(XLWorkbook file, Dictionary<int, IGoogleRecord> dataFormatedByCountry) /* Rapport classique avec DateRange */
        {
            var sheet = file.Worksheets.Add("Rapport Principal");
            int currentRow = 1;
            ...
            foreach (var valueDataForm in dataFormatedByCountry)
            {
                ...
                /* Entête de pays */
                sheet.Cell(currentRow, 1).Value = "Pays - MainReport ";
        ...
        private void GenerateDailyReport(XLWorkbook file, Dictionary<int, IGoogleRecord> dataFormatedByCountry)  /* PAR JOURS */
        {
            var sheet = file.Worksheets.Add("Rapport Journalier");
            int currentRow = 1;
            ...
            foreach (var valueDataForm in dataFormatedByCountry)
            {
                ...
                /* Entête de pays */
                sheet.Cell(currentRow, 1).Value = "Pays - DailyReport";
                sheet.Cell(currentRow, 2).Value = SwitchIdToCountryName(site);
                currentRow++;
        ...
        private void GenerateMonthlyReport(XLWorkbook file, Dictionary<int, IGoogleRecord> dataFormatedByCountry) /* PAR MOIS */
        {
            var sheet = file.Worksheets.Add("Rapport Mensuel");
            int currentRow = 1;
            ...
            foreach (var valueDataForm in dataFormatedByCountry)
            {
                ...
                /* Entête de pays */
                sheet.Cell(currentRow, 1).Value = "Pays - MonthlyReport";
                sheet.Cell(currentRow, 2).Value = SwitchIdToCountryName(site);
                currentRow++;
        ...
        private void GenerateYearlyReport(XLWorkbook file, Dictionary<int, IGoogleRecord> dataFormatedByCountry) /* PAR ANNÉES */
        {
            var sheet = file.Worksheets.Add("Rapport Annuel");
            int currentRow = 1;
            ...
            foreach (var valueDataForm in dataFormatedByCountry)
            {
                ...
                /* Entête de pays */
                sheet.Cell(currentRow, 1).Value = "Pays - YearlyReport";
                sheet.Cell(currentRow, 2).Value = SwitchIdToCountryName(site);
                currentRow++;
